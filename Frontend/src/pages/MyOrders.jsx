                        ...
                        {order.status === "DELIVERED" &&
                          !order.rating?.ratedAt && (
                            <button
                              ...
                              className="w-full sm:w-auto px-5 py-2.5 bg-yellow-400 text-white rounded-xl text-sm font-bold hover:bg-yellow-500 transition-colors flex items-center justify-center gap-1.5"
                            >
